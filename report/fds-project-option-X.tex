...
After processing the data and joining the resulting tables (see \textquote{Data processing} for details), we obtained a data set with 282 records and variables as outlined in Table~\ref{table:1}.
